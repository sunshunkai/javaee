...
public class SqlMapper {
     ...
     * @param sqlSession
     */
    public SqlMapper(@Autowired SqlSession sqlSession) {
    ...
    private class MSUtils {
        ...
        /**
         * 缓存，configuration.addMappedStatement并发会有异常，此处同步
         *
         * @param ms
         */
        private synchronized void addMappedStatement(MappedStatement ms) {
            if (hasMappedStatement(ms.getId())) {
                return;
            }
